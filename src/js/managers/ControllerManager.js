...
class ControllerManager {
  ...
  constructor() {
    ...
    EventBusSingleton.subscribe(START_CAMERA_LINK, () => {
      CinematicManager.isPlaying = true
    })
    EventBusSingleton.subscribe(END_CAMERA_LINK, () => {
      CinematicManager.isPlaying = false
    })
